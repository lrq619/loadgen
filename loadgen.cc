...
std::vector<QueryMetadata> GenerateQueries(
  ...
  printf("samples per query from settings: %d\n",samples_per_query);
  ...
  printf("queries size after emplace: %d\n",queries.size());
...
PerformanceResult IssueQueries(SystemUnderTest* sut,
  ...
  printf("Generated queries number: %d\n", queries.size());
  printf("Generated query sample number: %d\n", queries[0].query_to_send.size());
